...
timeout -k 2s 60s ../mrmaster ../pg*txt &

# give the master time to create the sockets.
sleep 1

# start multiple workers.
timeout -k 2s 60s ../mrworker ../../mrapps/wc.so &
timeout -k 2s 60s ../mrworker ../../mrapps/wc.so &
timeout -k 2s 60s ../mrworker ../../mrapps/wc.so &
...
# start multiple workers
timeout -k 2s 60s ../mrworker ../../mrapps/indexer.so &
timeout -k 2s 60s ../mrworker ../../mrapps/indexer.so
...
timeout -k 2s 60s ../mrworker ../../mrapps/mtiming.so &
timeout -k 2s 60s ../mrworker ../../mrapps/mtiming.so
...
timeout -k 2s 60s ../mrworker ../../mrapps/rtiming.so &
timeout -k 2s 60s ../mrworker ../../mrapps/rtiming.so
...
rm -f mr-done
(timeout -k 2s 60s ../mrmaster ../pg*txt ; touch mr-done ) &
sleep 1

# start multiple workers
timeout -k 2s 60s ../mrworker ../../mrapps/crash.so &
